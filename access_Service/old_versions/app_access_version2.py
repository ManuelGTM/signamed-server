...
def getPrediction_sendVid():
    query_parameters = request.args

    user_id = query_parameters.get('user_id')
    sign_id = query_parameters.get('sign_id')
    ...
    url_vid_sign, url_vid_def, definition = generate_download_signed_url_v4(sign_id, configs, dataset_anns)
