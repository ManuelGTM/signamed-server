...
class Processor():
    ...
    def load_model(self):
        ...
        if self.arg.weights:
            ...
            print (weights['fc.weight'].shape)
            print (weights['fc.bias'].shape)
    ...
    def load_data(self):
        ...
        if self.arg.phase == 'train':
            self.data_loader['train'] = torch.utils.data.DataLoader(
                dataset=Feeder(**self.arg.train_feeder_args, random_flip=True, dropout=True, random_resizer=True),
        ...
        self.data_loader['test'] = torch.utils.data.DataLoader(
            dataset=Feeder(**self.arg.test_feeder_args, random_flip=False),
